...
3. Configure file reading options:
...
5. Click **Process Data** to validate and prepare your data

### 2. Sample Annotation
1. Go to **🧬 Sample Annotation** tab
2. **Automatic Detection**: Click **🔍 Detect Sample Patterns**
   - Review suggested groupings with confidence scores
   - Select the best suggestion and click **✅ Accept Suggestion**
3. **Manual Setup**: If automatic detection fails
