...
bioc_packages <- c(
  ...
  # Fast gene conversion and caching
  ...
  # Pathway analysis packages - CRITICAL for v2.0
...
# CRAN packages for pathway analysis
pathway_cran_packages <- c(
...
# Install CRAN packages (including pathway CRAN packages)
cran_packages <- c(setdiff(required_packages, bioc_packages), pathway_cran_packages)
